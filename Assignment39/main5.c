/*
problem statment- Return the Smallest number of  element in singly link list 
*/
struct Node
{
    int data;
...
int main()
{
   ...
   InsretFirst(&First,no);
    ...
    iRet=SmallestNum(First);

     printf("Smallest Number in the  elements of singly link list  %d",iRet);
