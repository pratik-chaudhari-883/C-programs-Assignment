/*
problem statment- Return the largest number of  element in singly link list 
*/
struct Node
{
    int data;
...
int main()
{
   ...
   InsretFirst(&First,no);
    ...
    iRet=LargestNum(First);

     printf("Largest Number in the  elements of singly link list  %d",iRet);
